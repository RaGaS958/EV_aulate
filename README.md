...
![EV_aluate Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=300&section=header&text=EV_aluate&fontSize=90&animation=fadeIn&fontAlignY=38&desc=AI-Powered%20EV%20Intelligence%20Platform&descAlignY=55&descAlign=50)

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=667EEA&center=true&vCenter=true&multiline=true&repeat=false&width=800&height=100&lines=Predict+Innovation+%26+Sustainability;Powered+by+Advanced+Machine+Learning" alt="Typing SVG" />

[![Python](https://img.shields.io/badge/Python-3.8%2B-blue?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![Streamlit](https://img.shields.io/badge/Streamlit-1.28%2B-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://streamlit.io/)
[![XGBoost](https://img.shields.io/badge/XGBoost-2.0%2B-orange?style=for-the-badge&logo=xgboost&logoColor=white)](https://xgboost.readthedocs.io/)
...
graph LR
    A[🚗 EV Data<br/>360 Vehicles] --> B{Data Processing<br/>Pipeline}
    B --> C[🔋 CO₂ Model<br/>XGBoost<br/>99.57%]
    B --> D[🚀 Innovation Model<br/>Linear Regression<br/>99.04%]
    C --> E[🌍 Environmental<br/>Impact]
    D --> F[💡 Tech<br/>Innovation]
    ...
    style F fill:#fa709a,stroke:#fee140,stroke-width:3px,color:#fff
...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#667eea','primaryTextColor':'#fff','primaryBorderColor':'#764ba2','lineColor':'#f093fb'}}}%%
flowchart TD
    A[📁 Raw Data<br/>EV_cars.csv] --> B[🔧 Data Preprocessing]
    B --> C[📊 EDA & Visualization]
    C --> D[⚙️ Feature Engineering]
    D --> E[🎯 Feature Selection]
    E --> F{Model Training}
    
    F --> G[🌍 XGBoost<br/>CO₂ Model]
    F --> H[🚀 Linear Regression<br/>Innovation Model]
    
    G --> I[📦 Model Artifacts<br/>xgb.pkl]
    H --> J[📦 Model Artifacts<br/>linear.pkl]
    ...
    style H fill:#2575fc,stroke:#6a11cb,stroke-width:2px,color:#fff
    style K fill:#fa709a,stroke:#fee140,stroke-width:2px,color:#fff
...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#38ef7d','primaryTextColor':'#fff','lineColor':'#f093fb'}}}%%
graph TD
    A[📊 Input Features] --> B[🔋 Battery]
    A --> C[⚡ Fast Charge]
    A --> D[💰 Price]
    A --> E[🛣️ Range]
    A --> F[🏎️ Top Speed]
    
    B --> G[🤖 XGBoost Regressor]
    C --> G
    D --> G
    E --> G
    F --> G
...
```mermaid
pie title Feature Importance in CO₂ Model
    "Range" : 100
    "Battery" : 88
    "Top Speed" : 74
    "Fast Charge" : 71
...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#2575fc','primaryTextColor':'#fff','lineColor':'#f093fb'}}}%%
graph TD
    A[📊 Input Features] --> B[🔋 Battery]
    A --> C[⚡ Efficiency]
    A --> D[⚡ Fast Charge]
    ...
    B --> H{Feature Scaling<br/>MinMax 0-1}
    C --> H
    D --> H
    E --> H
    F --> H
    ...
    H --> I[🎯 Tech Edge<br/>40%]
    H --> J[🔋 Energy Intelligence<br/>40%]
    H --> K[💡 User Value<br/>20%]
    
    I --> L[🤖 Linear Regression]
    J --> L
    K --> L
    
    L --> M[🚀 Innovation Score<br/>0-1]
...
```mermaid
pie title Feature Importance in Innovation Model
    "Top Speed" : 90
    "Battery" : 85
    "Fast Charge" : 84
    "Range" : 79
...
```mermaid
graph TB
    A[Innovation Score] --> B[Tech Edge<br/>40%]
    A --> C[Energy Intelligence<br/>40%]
    A --> D[User Value<br/>20%]
    
    B --> E[Fast Charge<br/>50%]
    B --> F[Top Speed<br/>50%]
    
    C --> G[Efficiency<br/>60%]
    C --> H[Range<br/>40%]
    
    D --> I[Price<br/>50% inverse]
    D --> J[Acceleration<br/>50% inverse]
    
    E --> K((Normalized<br/>0-1))
    F --> K
    G --> K
    H --> K
    I --> K
...
```mermaid
graph LR
    A[Petrol Car<br/>150 g/km] --> C[Difference<br/>70 g/km]
    B[Electric Vehicle<br/>80 g/km] --> C
    C --> D[× Range<br/>km]
    D --> E[÷ 1000<br/>Convert to kg]
    E --> F[CO₂ Savings<br/>Result in kg]
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=footer&text=EV_aluate&fontSize=50&fontColor=fff&animation=twinkling&fontAlignY=75" width="100%"/>
